Below is the default documentation of the open source project I used.
working locally is as simple as npm install, npm run dev, and npm run build to create the dist folder.

The docs folder is needed to publish using github pages - it doesn't allow any other option aside from root/docs. So after you run the build, copy the dist folder into the docs folder.
